...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $message_body.="<tr><td colspan='2' style='color : #C50B33; font-size : 20px; '><b>Request For News Letter Subscription</b></td></tr>";
        $message_body.="<tr><td>Contact's Email : </td><td>".$_POST['email']."</td></tr>";
 
        $message_body.="</table></body></html>"; 
    
       
        $mail->From = 'designernetcom@gmail.com';
        $mail->FromName ='designernetcom@gmail.com'; 
		$mail->addAddress('designernetcom@gmail.com'); 
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'P. S. Diesel Spares';
        $mail->isHTML(true);
...
if($error=="")
{
      ...
      //  $mail->Port = 587;                                    // TCP port to connect to
        ...
        $message_body="<html><body><table border=5px>";
       $message_body.="<tr><td colspan='2' style='color : #C50B33; font-size : 20px; '><b>Enquiry generated for Mahindra Lifespaces Kharadi</b></td></tr>";
...
$mail->From = 'atcomforthomes@gmail.com';
        $mail->FromName ='atcomforthomes@gmail.com'; 
		$mail->addAddress('atcomforthomes@gmail.com'); 
	
       
       // $mail->AddAttachment( $_FILES['file']['tmp_name'], $_FILES['file']['name'] );
        $mail->Subject  = 'Mahindra Lifespaces';
        $mail->isHTML(true);
        $mail->Body = $message_body;
        ...
        {
           header("Location: thanks.html"); // Redirect to thanks.html
        }
        $mail->ClearAllRecipients();
        //$mail->clearAttachments();
        $mail->addAddress($_POST['email']);
